 ...
 * On your turn, you must capture at least one of your opponent’s pieces. The game ends when either user has
 * no more valid moves, and the win is assigned to the person with the most pieces. 
...
public class Question {
    ...
    private void getMove (int color) throws Exception {
        ...
        if (canGo(color)) {
            System.out.println ("Its " + (color == 1 ?
                    "white" : "black") + "'s turn:");
            int x, y;
