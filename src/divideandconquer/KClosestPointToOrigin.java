...
public class KClosestPointToOrigin {
        ...
        public static class ClosestPointComparator implements Comparator<Point>
        {
                ...
                public int compare(Point p1, Point p2) {
                        ...
                        return dist2.compareTo(dist1); // Need to create MaxHeap, so reversing here. This will give descending order
                }	
                                                     ...
                                                     int k)
        {
                ...
                PriorityQueue<Point> heapQueue = new PriorityQueue<KClosestPointToOrigin.Point>(k, cmp);
                ...
                {
                        if (cmp.compare(heapQueue.peek(), points.get(i)) < 0)  // i.e if points.get(i) is less than heapQueue.peek()
                        {
