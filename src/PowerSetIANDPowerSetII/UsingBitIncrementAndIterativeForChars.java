...
public class UsingBitIncrementAndIterativeForChars {
...
private static void printPowerSet(char[] set) {
	...
	for(int i=0;i<(int)Math.pow(2, set.length);i++){    // i is the bitCounter which starts from 0000 and goes till 0111
