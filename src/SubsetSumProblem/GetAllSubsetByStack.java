...
hence the solution is O(2^N) time complexity. Pick one number with index 'i' and check the 
sum with arrayElement + stack_sum is less than or equal to the target sum. If yes, then add the element
to the stack and also add the element to the stack_sum 
